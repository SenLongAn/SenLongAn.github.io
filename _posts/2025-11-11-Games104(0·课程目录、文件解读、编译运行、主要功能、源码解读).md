...
* ![1](/assets/img/blog/Games104/piccoloRun.png)
...
* 核心流程
* ![1](/assets/img/blog/Games104/piccolo构建流程.png)
* 构建流程
* ![1](/assets/img/blog/Games104/反射的元数据.png)
* generated文件解读
      ...
      * function功能层：
        ...
        * 子系统
          ...
          * 渲染 render
            ...
            * **passes**不同特性的封装pass（都继承自RenderPass）
            ...
            * **render_pipeline**.h
              ...
              * 前向渲染
                ...
                * 定向光draw
                * 点光源draw
                * 调用MainCameraPass drawcall，并传递各个pass
                * submit
            ...
            * **render_system**.h 
              ...
              * 函数：
                * 每帧
                  ...
                  * resource更新帧缓冲（pass共用数据：MVP，相机，环境光，点光源）
                  * scene更新可视的物体（按照数据分类，筛选所需的数据）
                  * pipeline预处理数据（对每个pass，更新自身成员数据）
                  * forwardRender、deferredRender
